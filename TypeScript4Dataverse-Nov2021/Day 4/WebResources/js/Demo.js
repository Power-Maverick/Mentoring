...
class Superherodemo {
    ...
    static onChange() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield dramaticWelcome();
            // Dataverse WebAPI
            let shQuery = yield Xrm.WebApi.retrieveMultipleRecords("account", `?fetchXml=<fetch version="1.0" mapping="logical" distinct="false">
                <entity name="account">
            ...
            // Generics
            genericsDemo("Hello Super Heros!");
        });
    }
}
exports.Superherodemo = Superherodemo;
...
function getStarWarsPeople() {
    fetch("https://swapi.dev/api/people/1").then((resp) => __awaiter(this, void 0, void 0, function* () {
        let people = yield resp.json();
...
function getStarWarsPeopleAxios() {
    axios.default.get("https://swapi.dev/api/people/1").then((resp) => __awaiter(this, void 0, void 0, function* () {
        let people = resp.data;
        console.log(`Axios: ${people.name} has birth year as ${people.birth_year}`);
    }));
}
function genericsDemo(arg) {
    return arg;
}
